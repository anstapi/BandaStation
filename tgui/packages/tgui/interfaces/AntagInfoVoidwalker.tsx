            ...
            <Section fill>
              <Stack vertical fill>
                ...
                <Stack.Item textColor="label">
                  ...
                  Вы обладаете непревзойдённой свободой. Оставайтесь на Марсе,
                  ...
                  их истощающим ударом, утащите на Марс (или рвоту туманности)
                  и просветите их.
                  <br />
                  <br />
            ...
            <Section fill title="Способности">
              <LabeledList>
                <LabeledList.Item label="Space Dive">
                  Вы можете свободно перемещаться по Марсу, используйте
                  это для охоты и проникновения в изолированные участки города.
                </LabeledList.Item>
                ...
                <LabeledList.Item label="Cosmic Physiology">
                  Ваша природная маскировка делает вас невидимым на Марсе, а
