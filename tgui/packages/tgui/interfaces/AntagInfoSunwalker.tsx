            ...
            <Section fill title="Способности">
              <LabeledList>
                <LabeledList.Item label="Space Dive">
                  Вы можете перемещаться под городом по Марсу, используйте
                  это для охоты и проникновения в изолированные участки Марса.
                </LabeledList.Item>
                ...
                <LabeledList.Item label="Burning Physiology">
                  ...
                  вакуум Марса заживляет любые раны, которые могли быть
