...
/datum/species/tajaran/get_species_lore()
	return list(
		...
		(на 61 % профинансированный корпорацией Trans-Solar Federation) с его флагманами ИКН «Хокинг» и МИК «Академик Старобинский» во главе, призванный объединить усилия по освоению галактики и, благодаря этому, \
		...
		которые продлились почти 4 года, после чего было заключено соглашение о вступлении таяр в галактическое сообщество на равных правах с остальными его участниками. В 2515 году таяры были внесены в реестр младших рас галактического сообщества, а корпорация Trans-Solar Federation победила в тендере на подъём технологического уровня Адомая.",
	)
