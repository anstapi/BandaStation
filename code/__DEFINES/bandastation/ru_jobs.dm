...
//No department
#define JOB_ASSISTANT_RU "Гражданин"
#define JOB_PRISONER_RU "Бездомный"
//Command
#define JOB_CAPTAIN_RU "Мэр"
#define JOB_HEAD_OF_PERSONNEL_RU "Кадровый менеджер"
#define JOB_HEAD_OF_SECURITY_RU "Начальник PD"
#define JOB_RESEARCH_DIRECTOR_RU "Директор лаборатории"
#define JOB_CHIEF_ENGINEER_RU "Координатор ID"
...
//NT Reprsentation
#define JOB_NANOTRASEN_REPRESENTATIVE_RU "Представитель ТСФ"
#define JOB_BLUESHIELD_RU "Телохранитель»"
//Justice
#define JOB_MAGISTRATE_RU "Главный судья"
#define JOB_LAWYER_RU "Частный юрист"
//Silicon
#define JOB_AI_RU "ИИ"
...
//Security
#define JOB_WARDEN_RU "Суперинтендант"
#define JOB_DETECTIVE_RU "Криминалист"
#define JOB_SECURITY_OFFICER_RU "Офицер PD"
#define JOB_SECURITY_OFFICER_MEDICAL_RU "Офицер PD (Медицина)"
#define JOB_SECURITY_OFFICER_ENGINEERING_RU "Офицер PD (Инженерия)"
#define JOB_SECURITY_OFFICER_SCIENCE_RU "Офицер PD (Исследование)"
#define JOB_SECURITY_OFFICER_SUPPLY_RU "Офицер PD (Снабжение)"
//Engineering
#define JOB_STATION_ENGINEER_RU "Специалист ID"
#define JOB_ATMOSPHERIC_TECHNICIAN_RU "Специалист энергосистем"
//Medical
...
#define JOB_ROBOTICIST_RU "Рипер"
#define JOB_GENETICIST_RU "Генетик"
//Supply
#define JOB_QUARTERMASTER_RU "Руководитель снабжения"
#define JOB_CARGO_TECHNICIAN_RU "Сотрудник ПВЗ"
#define JOB_CARGO_GORILLA_RU "Cargo Gorilla"
#define JOB_SHAFT_MINER_RU "Шахтер"
#define JOB_BITRUNNER_RU "Нетраннер"
