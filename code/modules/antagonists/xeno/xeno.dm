...
/datum/team/xeno/captive/roundend_report()
	...
	parts += "<span class='neutraltext'>Trans-Solar Federation thanks the crew of [station_name()] for providing much needed research data on <b>[thank_you_message]</b>.</span>"
