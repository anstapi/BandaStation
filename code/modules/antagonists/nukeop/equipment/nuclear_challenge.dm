...
/obj/item/nuclear_challenge/proc/war_was_declared(mob/living/user, memo)
	...
	if(station_techweb)
		...
		if (!isnull(announcement_system))
			announcement_system.broadcast("Additional research data received from Trans-Solar Federation R&D Division following the emergency protocol.", list(RADIO_CHANNEL_SCIENCE), TRUE)
