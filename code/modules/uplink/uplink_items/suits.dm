...
/datum/uplink_item/suits/infiltrator_bundle
	...
	desc = "Developed by the Roseus Galactic Actors Guild in conjunction with the Gorlex Marauders to produce a functional suit for urban operations, \
			...
			as well as causing significant demoralization amongst Trans-Solar Federation crew."
...
/datum/uplink_item/suits/space_suit
	...
	desc = "This red and black Syndicate space suit is less encumbering than Trans-Solar Federation variants, \
			fits inside bags, and has a weapon slot. Trans-Solar Federation crew members are trained to report red space suit \
			sightings, however."
