/datum/job/human_ai
	...
	total_positions = 0
	spawn_positions = 0
	supervisors = "Мэром, Директором Лаборатории и вашим сводом законов"
	...
	job_flags = (STATION_JOB_FLAGS & ~JOB_NEW_PLAYER_JOINABLE) | STATION_TRAIT_JOB_FLAGS | JOB_ANTAG_PROTECTED
