...
/datum/shuttle_loan_situation/antidote
	sender = "Командование ТСФ: Научно-исследовательский центр"
...
/datum/shuttle_loan_situation/department_resupply
	sender = "Командование ТСФ: Отдел снабжения"
...
/datum/shuttle_loan_situation/syndiehijacking
	sender = "Командование ТСФ: Контрразведка"
...
/datum/shuttle_loan_situation/lots_of_bees
	sender = "Командование ТСФ: Отдел по уборке"
...
/datum/shuttle_loan_situation/papers_please
	sender = "Командование ТСФ: Отдел бюрократии"
...
/datum/shuttle_loan_situation/pizza_delivery
	sender = "Командование ТСФ: Отдел космопиццы"
...
/datum/shuttle_loan_situation/russian_party
	sender = "Командование ТСФ: Программа по работе с русскими"
...
/datum/shuttle_loan_situation/spider_gift
	sender = "Командование ТСФ: Дипломатический корпус"
