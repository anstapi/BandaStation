...
/obj/item/keycard/nt_commsbuoy
	name = "Trans-Solar Federation comms buoy keycard"
...
/area/ruin/space/nt_commsbuoy
	name = "\improper Trans-Solar Federation Comms Buoy"
...
/obj/item/paper/fluff/ruins/nt_commsbuoy/table_of_contents
	...
	default_raw_text = {"
	<center><h3>Trans-Solar Federation Extraorbital Bluespace Communications Buoy Operations Manual</h3>
...
/obj/item/paper/fluff/ruins/nt_commsbuoy/torn_page
	...
	not listed in the manual, please refer to pages 48/54 to contact a Trans-Solar Federation Techician for direct assistance. <br>
	...
	on page 43. <br>
	2. Before entering the Comms Buoy, collect the Trans-Solar Federation Comms Buoy keycard provided in the front of this manual. This keycard is vital to \
	the repair process, operational efficiency of the Buoy, and in disabling the automated defensive system. <br>
	3. Display this card prominently on your persons. This can be done with an official Trans-Solar Federation neck lanyard or Trans-Solar Federation clip-on retractible laynard, \
	...
	7. Insert the Trans-Solar Federation Comms Buoy keycard into the slot along the bottom right of the terminal (refer to diagram RD-2).
	<hr>
...
/obj/item/paper/fluff/ruins/nt_commsbuoy/inspection
	...
	- Open space on the exterior chassis. Trans-Solar Federation insignia and paint? <u>Could sell advertising space?</u> <br>
...
/obj/machinery/computer/terminal/nt_commsbuoy/blackbox
	...
	content = list(
		"<i>Notice: this transcript was generated by Trans-Solar Federation speech-to-text. By reading this transcript you are hereby agreeing to the speech-to-text terms \
...
/obj/machinery/computer/terminal/nt_commsbuoy/relay
	...
	content = list(
		...
		<center><h5>The Spinward Project - brought to you by Trans-Solar Federation Futures and Innovation Division, in partnership with Trans-Solar Federation \
		...
		<center><h5>The Spinward Project - brought to you by Trans-Solar Federation Futures and Innovation Division, in partnership with Trans-Solar Federation Heavy Industry.</h5></center><hr>",
