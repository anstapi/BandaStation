...
/datum/design/paper_biscuit_confidential
	...
	desc = "A paper biscuit which can seal paperwork inside, this one is used for confidential Trans-Solar Federation documents. After sealing it the only way to open is through cracking it, cracking is irreversible and makes it permanently open. Not actually a biscuit."
