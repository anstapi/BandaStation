...
/obj/item/reagent_containers/cup/glass/ice/prison
	name = "dirty ice cup"
	desc = "Either Trans-Solar Federation's water supply is contaminated, or this machine actually vends lemon, chocolate, and cherry snow cones."
...
/obj/item/reagent_containers/cup/glass/mug/nanotrasen
	name = "\improper Trans-Solar Federation mug"
...
/obj/item/reagent_containers/cup/glass/shaker/Initialize(mapload)
	. = ..()
	if(prob(10))
		name = "\improper Trans-Solar Federation 20th Anniversary Shaker"
		desc += " It has an emblazoned Trans-Solar Federation logo on it."
		icon_state = "shaker_n"
