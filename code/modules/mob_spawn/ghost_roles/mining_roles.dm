...
/obj/effect/mob_spawn/ghost_role/human/hermit/Initialize(mapload)
	...
	switch(arrpee)
		...
		if(3)
			flavour_text += "you were a doctor on one of Trans-Solar Federation's space stations, but you left behind that damn corporation's tyranny and everything it stood for. From a metaphorical hell \
		...
		if(4)
			...
			at one of Trans-Solar Federation's state-of-the-art research facilities, were in one of the escape pods alone and saw the red button. It was big and shiny, and it caught your eye. You pressed \
