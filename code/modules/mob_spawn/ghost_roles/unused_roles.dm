...
/obj/effect/mob_spawn/ghost_role/human/prisoner_transport
	...
	you_are_text = "You're a prisoner, sentenced to hard work in one of Trans-Solar Federation's labor camps, but it seems as \
...
/obj/effect/mob_spawn/ghost_role/human/prisoner_transport/special(mob/living/carbon/human/spawned_human, mob/mob_possessor, apply_prefs)
	. = ..()
	spawned_human.fully_replace_character_name(null, "NTP #LL-0[rand(111,999)]") //Trans-Solar Federation Prisoner #Lavaland-(numbers)
...
/obj/effect/mob_spawn/ghost_role/human/syndicate
	...
	flavour_text = "You have awoken, without instruction. Death to Trans-Solar Federation! If there are some clues around as to what you're supposed to be doing, you best follow those."
...
/obj/effect/mob_spawn/ghost_role/human/nanotrasensoldier
	...
	you_are_text = "You are a Trans-Solar Federation Private Security Officer!"
...
/obj/effect/mob_spawn/ghost_role/human/commander
	...
	you_are_text = "You are a Trans-Solar Federation Commander!"
	flavour_text = "Upper-crusty of Trans-Solar Federation. You should be given the respect you're owed."
...
/obj/effect/mob_spawn/ghost_role/human/snow_operative
	...
	flavour_text = "Monitor Trans-Solar Federation communications and record information. All intruders should be disposed of \
...
/obj/effect/mob_spawn/ghost_role/human/syndicatespace
	...
	flavour_text = "Your ship docks after a long time somewhere in hostile space, reporting a malfunction. You are stuck here, with Trans-Solar Federation station nearby. Fix the ship, find a way to power it and follow your captain's orders."
...
/obj/effect/mob_spawn/ghost_role/human/syndicatespace/captain
	...
	flavour_text = "Your ship docks after a long time somewhere in hostile space, reporting a malfunction. You are stuck here, with Trans-Solar Federation station nearby. Command your crew and turn your ship into the most protected fortress."
