/datum/computer_file/program/restock_tracker
	...
	extended_desc = "Сеть Trans-Solar Federation IoT, в которой перечислены все торговые автоматы, находящиеся на станции, и насколько хорошо укомплектован каждый из них. Прибыльно!"
