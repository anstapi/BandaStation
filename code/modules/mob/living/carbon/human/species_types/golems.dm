...
/datum/species/golem/get_species_lore()
	return list(
		...
		it is believed they were originally constructed in Trans-Solar Federation laboratories as a form of cheap labor. Whatever happened up to this point is unknown, \
