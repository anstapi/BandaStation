...
/datum/species/shadow/get_species_lore()
	return list(
		...
		Around 2558, the long campaign Trans-Solar Federation waged against the space terrors ended with the full extinction of the Shadowlings.",
		...
		Trans-Solar Federation has assured the victims that they are searching for a cure. No further information has been given, even years later. \
		Most shadowpeople now assume Trans-Solar Federation has long since shelfed the project.",
	)
