/obj/item/mmi
	...
	desc = "The Warrior's bland acronym, MMI, obscures the true horror of this monstrosity, that nevertheless has become standard-issue on Trans-Solar Federation stations."
