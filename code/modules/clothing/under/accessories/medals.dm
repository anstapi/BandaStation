...
/obj/item/clothing/accessory/medal/proc/provide_reason(mob/living/carbon/human/distinguished, mob/user)
	commendation_message = tgui_input_text(user, "Reason for this commendation? It will be recorded by Trans-Solar Federation.", "Commendation", max_length = 140)
...
/obj/item/clothing/accessory/medal/conduct
	...
	desc = "A bronze medal awarded for distinguished conduct. Whilst a great honor, this is the most basic award given by Trans-Solar Federation. It is often awarded by a captain to a member of his crew."
...
/obj/item/clothing/accessory/medal/silver/security
	...
	desc = "An award for distinguished combat and sacrifice in defence of Trans-Solar Federation's commercial interests. Often awarded to security staff."
...
/obj/item/clothing/accessory/medal/silver/excellence
	...
	desc = "Trans-Solar Federation's dictionary defines excellence as \"the quality or condition of being excellent\". This is awarded to those rare crewmembers who fit that definition."

/obj/item/clothing/accessory/medal/silver/bureaucracy
	name = "\improper Excellence in Bureaucracy Medal"
	desc = "Awarded for exemplary managerial services rendered while under contract with Trans-Solar Federation."
...
/obj/item/clothing/accessory/medal/gold/captain
	...
	desc = "A golden medal awarded exclusively to those promoted to the rank of captain. It signifies the codified responsibilities of a captain to Trans-Solar Federation, and their undisputable authority over their crew."
...
/obj/item/clothing/accessory/medal/silver/emergency_services
	...
	desc = "A silver medal awarded to the outstanding emergency service workers of Trans-Solar Federation, those who work tirelessly together through adversity to keep their crew safe and breathing in the harsh environments of outer space."
