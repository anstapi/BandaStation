...
/obj/item/clothing/shoes/jackboots
	name = "jackboots"
	desc = "Trans-Solar Federation-issue Security combat boots for combat scenarios or combat situations. All combat, all the time."
	icon_state = "jackboots"
	inhand_icon_state = "jackboots"
	supports_variations_flags = CLOTHING_DIGITIGRADE_MASK
	bodyshapes_with_variations = BODYSHAPE_DIGITIGRADE
...
/obj/item/clothing/shoes/workboots
	name = "work boots"
	desc = "Trans-Solar Federation-issue Engineering lace-up work boots for the especially blue-collar."
