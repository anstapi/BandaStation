...
///Trans-Solar Federation documents
/obj/item/documents/nanotrasen
	desc = "\"Top Secret\" Trans-Solar Federation documents, filled with complex diagrams and lists of names, dates and coordinates."
